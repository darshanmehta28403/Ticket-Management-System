...
const registerUser = async (req, res) => {
    try {
        ...
        // Generate JWT
        const token = jsonwebtoken_1.default.sign({ userId: newUser.id, email: newUser.email, role: newUser.role.title }, JWT_SECRET, { expiresIn: "1d" });
...
const loginUser = async (req, res) => {
    try {
        ...
        // Generate JWT
        const token = jsonwebtoken_1.default.sign({ userId: user.id, email: user.email, role: user.role.title }, JWT_SECRET, { expiresIn: "1d" });
